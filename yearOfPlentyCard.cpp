...
namespace ariel
{
    ...
    {
        std::cout << "Choose first Resource: 1 for brick, 2 for ore, 3 for grain, 4 for wool or 5 for lumber  - " << std::endl;
        int choice1;
        std::cin >> choice1;
        std::cout << "Choose second Resource: 1 for brick, 2 for ore, 3 for grain, 4 for wool or 5 for lumber  - " << std::endl;
        int choice2;
        std::cin >> choice2;
